...
using Judgy.Providers.OpenAI.Tests.Fakes;
using Xunit;

namespace Judgy.Providers.OpenAI.Tests;
...
public class OpenAiProviderTests
{
    ...
    private static OpenAiProviderOptions MakeOptions(FakeHttpMessageHandler handler) =>
        new()
        {
            ApiKey = ValidApiKey,
    ...
    public async Task CompleteAsync_SendsCorrectRequest()
    {
        ...
        using var provider = new OpenAiProvider(MakeOptions(handler));
    ...
    {
        var act = () => new OpenAiProvider(new OpenAiProviderOptions { ApiKey = "" });
    ...
    public async Task CompleteAsync_UsesCustomModel()
    {
        ...
        using var provider = new OpenAiProvider(options);
        var request = new Judgy.Providers.LlmRequest(TestPrompt);
